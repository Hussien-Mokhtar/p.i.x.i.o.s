...
export default function ShopADynamic({shopA}) {
  ...
  <div className="parentt rounded-2xl p-1 text-center relative">
    <LazyLoadImage src={shopA.img} alt="All Product 1" className=" h-[19rem] w-[40rem]  hover:-translate-y-3 duration-150 rounded-xl" />
       <p className="flex justify-around font-bold">{shopA.title}<span>{shopA.price}</span></p>
