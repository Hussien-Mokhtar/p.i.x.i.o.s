    ...
    <>
      <div className="container lg:mx-10 grid lg:grid-cols-2 grid-cols-1 text-center ">
        <div className="clipp relative" data-aos="fade-right" data-aos-duration="1500">
          <img src={pink}  alt="" /> <span className=" text-black absolute bottom-10 left-16 font-bold text-2xl border border-black bg-white rounded-md p-2 hover:bg-black hover:text-white duration-150 cursor-pointer">Woman Collection</span></div>
        ...
        <div className="flex justify-around px-8 py-4">
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 py-4 lg:gap-20 gap-6 ml-10">
            <div className="relative w-[16rem]"><img src={children} alt="" className="rounded-xl hover:scale-110 duration-150 "/> <span className="absolute left-10 bottom-10 bg-white border border-black rounded-md px-4 py-1 font-semibold hover:bg-black hover:text-white duration-150 cursor-pointer">Child Fashion</span></div>

            <div className=" relative w-[16rem]"><img src={boy} alt="" className="rounded-xl hover:scale-110 duration-150"/><span className="absolute left-8 bottom-5 bg-white border border-black rounded-md px-4 py-1 font-semibold hover:bg-black hover:text-white duration-150 cursor-pointer">Man collection</span></div>
          </div>
