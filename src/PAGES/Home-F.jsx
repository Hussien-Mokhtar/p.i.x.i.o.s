    ...
    <>
      <div className=" mx-4 px-4 grid lg:grid-cols-2 grid-cols-1">
        ...
        <div className="flex justify-between ">
            ...
            <Link to="/shop"><MdArrowRightAlt className=" lg:text-8xl text-7xl border-2 border-dotted border-black rounded-full p-2 hover:scale-110 duration-150 hover:text-blue-600"/>
            </Link>
        </div>
