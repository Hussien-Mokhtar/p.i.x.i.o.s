...
<div className="mx-4 py-8 relative" data-aos="fade-up" data-aos-duration="1500">
    <LazyLoadImage src={HomeM.img} alt="" className=" rounded-3xl w-[20rem] "/>
    <LazyLoadImage src={HomeM.logo} alt="" className="absolute left-0 bottom-[5.5rem] lg:h-[11rem] h-[13rem] w-[20rem] bg-black bg-opacity-20 rounded-3xl p-16 hover:scale-110 duration-150"/>
