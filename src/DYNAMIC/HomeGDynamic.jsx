...
export default function HomeGDynamic({HomeG}) {
  return (
    <>
      <div className="px-4 mx-4 pt-8 relative font-semibold text-sm" >
        <LazyLoadImage src={HomeG.img} alt="" className='lg:h-[15rem] lg:w-[16rem] rounded-xl hover:scale-110 duration-150'/>
